...
static int dummy_bind_to_tz(struct thermal_zone_device *tz)
{
	return 0;
}

static void dummy_unbind_from_tz(struct thermal_zone_device *tz)
{
}

static struct thermal_governor thermal_gov_dummy = {
	.name		= "dummy",
	.bind_to_tz	= dummy_bind_to_tz,
	.unbind_from_tz	= dummy_unbind_from_tz,
};
