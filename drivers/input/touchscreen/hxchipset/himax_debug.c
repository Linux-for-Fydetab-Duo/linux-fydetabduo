...
static bool chk_normal_str(char *str)
{
	int i = 0;
	bool result = false;
...
static bool chk_normal_char(char c)
{
	bool result = false;
...
static int himax_set_diag_cmd(struct himax_ic_data *ic_data,
...
/* DSRAM thread */
static bool himax_ts_diag_func(int dsram_type)
{
	int i = 0, j = 0;
...
static void hx_dump_prog_set(uint8_t prog)
{
...
static void himax_ts_dump_func(void)
{
	uint8_t tmp_addr[DATA_LEN_4] = {0};
	int ret = NO_ERR;
