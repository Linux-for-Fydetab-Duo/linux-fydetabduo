...
#define SYNA_CSI_DATA_Q8_REAL(t) \
  (((0 < _Q8_REAL_SI(t)) ? (-1) : (1)) * ((int32)_Q8_REAL_MA(t)))
#define SYNA_CSI_DATA_Q8_IMAGE(t) \
  (((0 < _Q8_IMAGE_SI(t)) ? (-1) : (1)) * ((int32)_Q8_IMAGE_MA(t)))
#define SYNA_CSI_DATA_Q8_EXP(t) (((int8)(0xf8 & ((t) << 3))) >> 3)
/* (14,14) Q13 fixed point data format */
#define SYNA_CSI_DATA_Q13_REAL(t) \
  (((int32)(0xfff30000 & ((t) << 4))) >> (14 + 4))
#define SYNA_CSI_DATA_Q13_IMAGE(t) \
  (((int32)(0xfff30000 & ((t) << 18))) >> (0 + 18))
...
#define SYNA_CSI_DATA_Q11_REAL(t) \
  (((0 < _Q11_REAL_SI(t)) ? (-1) : (1)) * ((int32)_Q11_REAL_MA(t)))
#define SYNA_CSI_DATA_Q11_IMAGE(t) \
  (((0 < _Q11_IMAGE_SI(t)) ? (-1) : (1)) * ((int32)_Q11_IMAGE_MA(t)))
#define SYNA_CSI_DATA_Q11_EXP(t) (((int8)(0xfc & ((t) << 2))) >> 2)
...
#define CSI_CFR_TOTAL_LENGTH(data_len) (sizeof(union dhd_cfr_header) + data_len)
...
#define SYNA_CSI_CFR_NODE_FREE_LEN(ptr) \
  (((struct csi_cfr_node *)(ptr))->total_size - SYNA_CSI_CFR_NODE_LEN)
 ...
 *         == 0        successful
 */
extern int dhd_csi_event_handler(dhd_pub_t *dhdp, const wl_event_msg_t *event,
                                 void *event_data);
