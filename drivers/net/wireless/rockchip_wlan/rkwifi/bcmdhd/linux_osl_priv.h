...
#define STATIC_PKT_1_2PAGE_NUM ((STATIC_PKT_1PAGE_NUM) + (STATIC_PKT_2PAGE_NUM))
#define STATIC_PKT_MAX_NUM ((STATIC_PKT_1_2PAGE_NUM) + (STATIC_PKT_4PAGE_NUM))
...
struct osl_info {
  ...
  /* for host drivers, a bus handle is needed when reading from and/or writing
   * to dongle registeres, however ai/si utilities only passes osh handle to
   * R_REG and W_REG. as a work around, save the bus handle here
   */
  void *bus_handle;
#ifdef BCMDBG_CTRACE
